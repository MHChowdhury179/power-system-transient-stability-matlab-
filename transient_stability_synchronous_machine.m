...
% EACFAULT applies the equal area criterion to a critically cleared system.
% Inputs:
% Pm = Generator output/mechanical power in p.u.
% E  = Generator e.m.f. in p.u.
% V  = Infinite bus-bar voltage in p.u.
% X1 = Reactance before fault in p.u.
% X2 = Reactance during fault in p.u.
% X3 = Reactance after fault in p.u.
